...
namespace ChushkaMiro.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var chushkaDbContext = _context.Orders.Include(o => o.Product).Include(o => o.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,UserId,OrderedOn")] Orders orders)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductId,UserId,OrderedOn")] Orders orders)
        {
            if (id != orders.Id)
            {
                return NotFound();
